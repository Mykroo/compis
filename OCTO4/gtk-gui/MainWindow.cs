...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='newAction' action='newAction'/><toolitem name='openAction' action='openAction'/><toolitem name='saveAction' action='saveAction'/><toolitem name='saveAsAction' action='saveAsAction'/><toolitem name='noAction' action='noAction'/><toolitem name='dialogErrorAction1' action='dialogErrorAction1'/><toolitem name='findAndReplaceAction' action='findAndReplaceAction'/><toolitem name='findAction' action='findAction'/><toolitem name='indentAction' action='indentAction'/><toolitem name='executeAction' action='executeAction'/></toolbar></ui>");
